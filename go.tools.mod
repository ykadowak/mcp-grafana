// This is a separate go.mod file for tools, which allows us to separate
// the tool dependencies from the main codebase.
//
// Standard commands should be in the Makefile, but you can also use it
// with `go run -modfile go.tools.mod <tool>`.
